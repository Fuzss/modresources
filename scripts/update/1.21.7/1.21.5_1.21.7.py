...
if not os.path.exists(projectPath):
    shutil.copytree(projectSource, projectPath)
    print(f"Copied {projectSource} → {projectPath}")
...
newProperties = {
    ...
    "dependenciesPuzzlesLibVersion": "21.7.1",
    "dependenciesMinPuzzlesLibVersion": "21.7.1"
}
...
subprocess.run(["./gradlew", "fabricClient"], cwd=projectPath, check=True)
