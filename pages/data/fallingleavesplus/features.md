* 🍃 **Ambient Falling Leaves:** Expands Minecraft's ambient falling leaves with richer visuals and greater variety.
* 🌳 **Tree-Specific Particles:** Different tree types can produce their own unique leaves, branches, acorns, cones, and other debris.
* ✨ **Particle Variations:** Individual leaf types can use multiple particle textures for a more natural and less repetitive look.
* ❄️ **Snowflake Support:** Snow-covered leaves can spawn snowflakes instead of leaves for a more atmospheric winter experience.
