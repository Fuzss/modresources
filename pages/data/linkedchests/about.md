**Linked Chests** adds shared storage channels that can be accessed from matching chests placed anywhere in the world. Set a chest’s channel with three dye colors, then open any chest using the same combination to reach the same inventory. 🎨
