* **🖼️ Click Through Decorations:** Interact with usable blocks behind item frames, glow item frames, signs, and banners.
* **📦 Easier Hidden Storage:** Open attached containers like chests without needing to click around decorative blocks or entities.
* **🛠️ Works With Functional Blocks:** Use chests, crafting tables and other interactive blocks even when covered by supported decorations.
* **🌐 Flexible Client and Server Use:** Works in singleplayer, server-side multiplayer, and client-only multiplayer with server-side limitations.
